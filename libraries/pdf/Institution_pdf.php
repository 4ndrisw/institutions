...
class Institution_pdf extends App_pdf
{
    ...
    public function __construct($institution, $tag = '')
    {
        ...
        $this->SetTitle($this->institution_number);
    }
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_institutionpdf.php';
        $actualPath = module_views_path('institutions','themes/' . active_clients_theme() . '/views/institutions/institutionpdf.php');
