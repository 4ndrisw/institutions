      ...
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <?php echo form_open(site_url('institutions/office_pdf/'.$institution->id), array('class'=>'pull-right action-button')); ?>
      ...
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            ...
            <div class="col-sm-6 text-right transaction-html-info-col-right">
               <span class="bold institution_to"><?php echo _l('institution_office_to'); ?>:</span>
               <address class="institution-html-customer-billing-info">
                  <?php echo format_office_info($institution->office, 'office', 'billing'); ?>
               </address>
               <!-- shipping details -->
               ...
               <address class="institution-html-customer-shipping-info">
                  <?php echo format_office_info($institution->office, 'office', 'shipping'); ?>
               </address>
               <?php } ?>
            </div>
         </div>
         <div class="row">
            ...
            <div class="col-sm-12 text-left transaction-html-info-col-left">
               <p class="institution_to"><?php echo _l('institution_opening'); ?>:</p>
               <span class="institution_to"><?php echo _l('institution_client'); ?>:</span>
               <address class="institution-html-customer-billing-info">
