...
$(function() {
    ...
    $('#clientid').on('change', function() {
        ...
        var clonedProjectsAjaxSearchSelect = programAjax.html('').clone();
        var programsWrapper = $('.programs-wrapper');
        programAjax.selectpicker('destroy').remove();
        programAjax = clonedProjectsAjaxSearchSelect;
        $('#program_ajax_search_wrapper').append(clonedProjectsAjaxSearchSelect);
        init_ajax_program_search_by_customer_id();
    });
